  ...
  describe("when there is a piece", () => {
    describe("when the state is Waiting", () => {
      it("returns the PieceSelected state with the new piece", () => {
        const piece = O.Piece.Active.active("blue", ["a", 1], false);

        const game: O.State.State = {
          blue: {
            pieces: [
              piece,
              O.Piece.Active.active("blue", ["b", 1], false),
              O.Piece.Active.active("blue", ["c", 1], true),
              O.Piece.Active.active("blue", ["d", 1], false),
              O.Piece.Active.active("blue", ["e", 1], false),
            ],
            actions: [
          ...
          red: {
            pieces: [
              O.Piece.Active.active("red", ["a", 5], false),
              O.Piece.Active.active("red", ["b", 5], false),
              O.Piece.Active.active("red", ["c", 5], true),
              O.Piece.Active.active("red", ["d", 5], false),
              O.Piece.Active.active("red", ["e", 5], false),
            ],
            actions: [
    ...
    describe("when the state is PieceSelected", () => {
      it("returns the PieceSelected state with the new piece", () => {
        const piece = O.Piece.Active.active("blue", ["a", 1], false);
        const otherPiece = O.Piece.Active.active("blue", ["b", 1], false);
    ...
    describe("when the state is Waiting", () => {
      it("returns the state unchanged", () => {
        const game: O.State.State = {
          blue: {
            pieces: [
              O.Piece.Active.active("blue", ["a", 1], false),
              O.Piece.Active.active("blue", ["b", 1], false),
              O.Piece.Active.active("blue", ["c", 1], true),
              O.Piece.Active.active("blue", ["d", 1], false),
              O.Piece.Active.active("blue", ["e", 1], false),
